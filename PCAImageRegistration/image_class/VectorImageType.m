    ...
    methods(Access = public)
        ...
        function obj = VectorImageType(size,origin,spacing,orientation)
            ...
            elseif(nargin > 0)
                ...
                obj.index = s*0+1; % by default, the index points to the first pixel.
            end
        end
        
        function im = force2D(obj)
            im = VectorImageType(obj);
            im.data = obj.data;
            im.size= im.size(1:2);
        ...
        function P = GetValue(obj, pos, varargin)
            ...
            if (strcmp(mode,'NN'))
                ...
                elseif ndims ==2
                    in_1D = sub2ind(obj.size',round_index(1,:),round_index(2,:));
                end
                ...
                if inplane
                    ...
                    if use_jet
                        ...
                        for i=1:size(arrow_colors,1)
                            ...
                            reoriented_vectors =  [obj.datax(idx) obj.datay(idx) obj.dataz(idx)];
